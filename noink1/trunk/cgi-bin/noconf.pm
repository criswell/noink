...
$fourm_other_posts{$root_sites[0]} = $yes; #set to $yes if you will allow other (anonymous) posts to forum.
...
undef $ReadImage{$root_sites[0]}; # Comment if you want a background image behind the web-content
#$RearImage{$root_sites[0]} = "/some/dir/image.img"; # Uncomment if you want a backgroun image behind the web-content

undef $BGImage{$root_sites[0]}; # Comment if you want a background image
#$BGImage{$root_sites[0]} = "/some/dir/image.img"; # Uncomment if you want a background image

#undef $banner_file{$root_sites[0]}; # Uncomment if no banners on your site
$banner_file{$root_sites[0]} = "/www/univ/banner.html"; # Comment if no banners on your site

$copyrite_small{$root_sites[0]} = "/www/univ/copyrite_s.html"; #Small, typically one-line copyright for bottom of everypage
$copyrite_large{$root_sites[0]} = "/www/univ/copyrite_l.html"; #Large, typically detailed and full-page copyright
...
$msg_forum_noother{$root_sites[0]} = "Sorry, anonymous posts cannot be made!";
...
$msg_archive_main{$root_sites[0]} = "Archives";
$msg_archive_previous{$root_sites[0]} = "Previous";
$msg_archive_next{$root_sites[0]} = "Next";
...
$msg_to_update_section{$root_sites[0]} = "Click here to update this section...";
...
###########################################################################################################
# Repeat above code if necessary for multiple sites!
###########################################################################################################
...
# Location of General site copyright file
$general_copyright = "/www/univ/copyrite.html";
